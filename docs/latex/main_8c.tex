...
\item[\mbox{\hyperlink{todo__todo000001}{Todo}}]Include a print\+\_\+info() method that prints out Lispy version and exiting as well as build information (date, time, libc version, compiler version).\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000002}{Todo}}]Make the function portable, and choose an alternative directory in case XDG\+\_\+\+CACHE\+\_\+\+HOME does not exist.\end{DoxyRefDesc}
